---
title: 'Contributors'
description: 'Everyone who ever contributed to Laravext'
---
...
- [Felipe Eufrasio](https://github.com/garumam): 
    - [withHeadTitle](/docs/tools/nexus-response#withheadtitletitle-and-withheaddescriptiondescription) method
    - [withViewSkeleton](/docs/tools/nexus-response#withviewskeletonview-props--) method
