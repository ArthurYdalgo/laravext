...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { routeName: "admin.companies.create" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(pagination.data, (resource) => {
              ...
              if (resource.website) {
                _push2(ssrRenderComponent(_sfc_main$1, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${ssrInterpolate(resource.website)}`);
                    } else {
                      return [
                        createTextVNode(toDisplayString(resource.website), 1)
                      ];
                    }
                  }),
                  _: 2
              ...
              _push2(ssrRenderComponent(_sfc_main$1, {
                href: `/admin/companies/${resource.id}`
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
              ...
              _push2(ssrRenderComponent(_sfc_main$1, {
                href: `/admin/companies/${resource.id}/edit`
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
            ...
            return [
              ...
              createVNode("table", {
                ...
                createVNode("thead", null, [
                  ...
                  createVNode("th", { class: "border-l px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider" }, " Website "),
                    ...
                    return openBlock(), createBlock("tr", {
                      ...
                      createVNode("td", { class: "border-t border-l px-6 py-4 whitespace-no-wrap" }, [
                        createVNode("div", { class: "text-sm leading-5 text-gray-900" }, [
                          resource.website ? (openBlock(), createBlock(_sfc_main$1, {
                            key: 0,
                            class: "text-blue-600",
                            href: resource.website
                          }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/nexus/(global)/(auth)/admin/companies/page.vue");
