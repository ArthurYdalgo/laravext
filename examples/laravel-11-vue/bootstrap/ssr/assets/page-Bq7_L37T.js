import { inject, reactive, onMounted, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, withDirectives, unref, vModelText, Fragment, renderList, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
      ...
      swal({
        ...
        if (result.isConfirmed) {
          axios.delete(`/api/teams/${id}`).then(() => {
            fetchResources();
            swal(t("Record deleted!"), t("The team has been deleted."), "success");
          }).catch((error) => {
            console.error(error);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { routeName: "admin.teams.create" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(pagination.data, (resource) => {
              ...
              _push2(ssrRenderComponent(_sfc_main$1, {
                href: `/admin/teams/${resource.id}/edit`
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(pagination.data, (resource) => {
                    return openBlock(), createBlock("tr", {
                      ...
                      createVNode("td", { class: "border-t border-l px-6 py-4 whitespace-no-wrap" }, [
                        createVNode("div", { class: "text-sm leading-5 text-gray-900" }, toDisplayString(resource.name), 1)
                      ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/nexus/(global)/(auth)/admin/teams/page.vue");
