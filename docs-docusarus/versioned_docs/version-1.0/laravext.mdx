...
You may think of it as a Next.js' file based router inside your Laravel project. There're some methods that slightly remember Inertia.js as well. It offers 3 ways to [dinamically create server-side rendered pages](/docs/server-side-rendering) based on your needs so your application is SEO friendly, one of them in the Inertia.js style, and two of them in the Blade style.
