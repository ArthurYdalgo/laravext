...
Simply change the `'laravext.localization.enabled'` and the `'laravext.localization.enabled'` [localization configuration](/docs/configuration#localization-localization) as you see fit, create
