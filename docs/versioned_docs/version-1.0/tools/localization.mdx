...
Simply change the `'laravext.localization.enabled'` and the `'laravext.localization.locales'` [localization configuration](/docs/configuration#localization-localization) as you see fit, 
