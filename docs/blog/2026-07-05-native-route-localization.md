...
You can check more details about this in the [Localization](/docs/tools/localization) and in the [Configuration](/docs/configuration#localization-localization) sections of this documentation.
