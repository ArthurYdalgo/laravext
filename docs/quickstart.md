...
(The following code contains a `$head` variable that is described in the [Tools/Nexus Response/withHead](/tools/nexus-response?id=withheadstringintarray-name-value-null) section. You can remove it if you're not going to use it)
