          ...
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$1, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.$t("Return to"))} ${ssrInterpolate(_ctx.$t("Company"))} #${ssrInterpolate(unref(routeParams)().company)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(_ctx.$t("Return to")) + " " + toDisplayString(_ctx.$t("Company")) + " #" + toDisplayString(unref(routeParams)().company), 1)
                  ];
                }
              }),
              _: 1
            ...
            ssrRenderList(pagination.data, (resource) => {
              ...
              if (resource.team) {
                _push2(ssrRenderComponent(_sfc_main$1, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`${ssrInterpolate(resource.team.name)}`);
                    } else {
                      return [
                        createTextVNode(toDisplayString(resource.team.name), 1)
                      ];
                    }
                  }),
                  _: 2
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/nexus/(global)/(auth)/admin/companies/{company}/projects/page.vue");
