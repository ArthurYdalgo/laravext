...
document.addEventListener('DOMContentLoaded', function () {
    createLaravextApp({
        ...
        // By default, Laravext redirects to the intended URL after actions like login.
        // If you want to disable this behavior globally on the client side router, set this to false.
