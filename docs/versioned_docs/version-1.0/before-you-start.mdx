...
Much like when you run a `laravel new` and get the option to scaffold a new project with some basic configurations, Laravext has some starter kits that you can use to start a new project. You can use one of the following commands:
