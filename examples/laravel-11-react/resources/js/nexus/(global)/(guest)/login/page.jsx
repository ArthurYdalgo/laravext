    ...
    return (
        <div className="flex justify-center items-center min-h-[70vh] mt-6">
            <form onSubmit={submit} className="w-96">
                <h3 className="mt-6 justify-center text-2xl font-semibold text-gray-900 dark:text-white text-center">Login</h3>
                ...
                <div className="block mt-4">
                    <label className="flex items-center">
                        ...
                        <span className="ms-2 text-sm text-gray-600 dark:text-gray-400">{t('Remember me')}</span>
                    </label>
                </div>
