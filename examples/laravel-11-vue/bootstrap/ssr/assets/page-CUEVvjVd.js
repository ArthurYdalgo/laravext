import { inject, reactive, onMounted, withCtx, createTextVNode, toDisplayString, createVNode, unref, openBlock, createBlock, createCommentVNode, withDirectives, vModelText, Fragment, renderList, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
      ...
      swal({
        ...
        if (result.isConfirmed) {
          axios.delete(`/api/developers/${id}`).then(() => {
            fetchResources();
            swal(t("Record deleted!"), t("The developer has been deleted."), "success");
          }).catch((error) => {
            console.error(error);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { routeName: "admin.developers.create" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(pagination.data, (resource) => {
                ...
                _push2(ssrRenderComponent(_sfc_main$1, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    ...
                    if (_push3) {
                      ...
                      return [
                        createTextVNode(toDisplayString((_b = resource.team) == null ? void 0 : _b.name), 1)
                      ];
                    }
                  }),
                  _: 2
              ...
              _push2(ssrRenderComponent(_sfc_main$1, {
                href: `/admin/developers/${resource.id}/edit`
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
              ...
              createVNode("table", {
                ...
                createVNode("thead", null, [
                  createVNode("tr", null, [
                    ...
                    createVNode("th", { class: "border-l px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider" }, toDisplayString(_ctx.$t("Username")), 1),
                    ...
                    createVNode("th", { class: "border-l px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider" }, toDisplayString(_ctx.$t("Role")), 1),
                    createVNode("th", { class: "border-l px-6 py-3 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider" }, toDisplayString(_ctx.$t("Email")), 1),
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(pagination.data, (resource) => {
                    ...
                    return openBlock(), createBlock("tr", {
                      ...
                      createVNode("td", { class: "border-t border-l px-6 py-4 whitespace-no-wrap" }, [
                        createVNode("div", { class: "text-sm leading-5 font-medium text-gray-900" }, " @" + toDisplayString(resource.username), 1)
                      ]),
                      createVNode("td", { class: "border-t border-l px-6 py-4 whitespace-no-wrap" }, [
                        createVNode("div", { class: "text-sm leading-5 font-medium text-gray-900" }, toDisplayString(resource.name), 1)
                      ]),
                      createVNode("td", { class: "border-t border-l px-6 py-4 whitespace-no-wrap" }, [
                        createVNode("div", { class: "text-sm leading-5 font-medium text-gray-900" }, toDisplayString(_ctx.$t(resource.role_label)), 1)
                      ]),
                      createVNode("td", { class: "border-t border-l px-6 py-4 whitespace-no-wrap" }, [
                      ...
                      createVNode("td", { class: "border-t border-l px-6 py-4 whitespace-no-wrap" }, [
                        createVNode("div", { class: "text-sm leading-5 text-gray-900" }, [
                          resource.team ? (openBlock(), createBlock(_sfc_main$1, {
                            key: 0,
                            class: "text-blue-600",
                            href: `/admin/teams/${(_a = resource.team) == null ? void 0 : _a.id}`
                          }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/nexus/(global)/(auth)/admin/developers/page.vue");
