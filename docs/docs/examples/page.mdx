...
These examples will mostly focus on how to use the page [file convention](/docs/concepts/file-conventions) and the [Laravext prop](/docs/concepts/laravext-prop) to create a page.
